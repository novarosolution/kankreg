        ...
        <View style={styles.qcBody}>
          ...
          {ratingAvg > 0 ? (
            <View style={styles.qcRatingRow}>
              <Ionicons name="star" size={icon.tiny} color={ALCHEMY.gold} />
...
function createStyles(c, isDark) {
  ...
  return StyleSheet.create({
    ...
    card: {
      ...
      borderTopWidth: 2,
      borderTopColor: isDark ? "rgba(232, 200, 90, 0.5)" : "rgba(201, 162, 39, 0.65)",
      ...cardLiftShadow,
      ...Platform.select({
        web: {
    ...
    qcRatingRow: {
      ...
      paddingVertical: 4,
      borderRadius: radius.pill,
      backgroundColor: isDark ? "rgba(201, 162, 39, 0.1)" : ALCHEMY.goldSoft,
      borderWidth: StyleSheet.hairlineWidth,
      borderColor: isDark ? c.primaryBorder : "rgba(201, 162, 39, 0.2)",
    },
    qcRatingText: {
      ...
      ...platformShadow({
        web: {
          boxShadow: isDark
            ...
            : "0 8px 20px rgba(28, 25, 23, 0.07), 0 2px 8px rgba(61, 42, 18, 0.04), inset 0 1px 0 rgba(255,255,255,0.82)",
        },
        ios: {
          shadowColor: "#3D2A12",
    ...
    cardListEditorial: {
      ...
      borderTopColor: isDark ? "rgba(255,255,255,0.1)" : "rgba(201, 162, 39, 0.55)",
