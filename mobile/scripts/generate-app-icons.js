...
const svgPath = path.join(root, "assets", "SVG.svg");
const assetsDir = path.join(root, "assets");
const cream = { r: 255, g: 252, b: 248, alpha: 1 };

async function main() {
  if (!fs.existsSync(svgPath)) {
    console.error("Missing assets/SVG.svg.");
    process.exit(1);
  }
  ...
  console.log("Wrote assets/icon.png, assets/adaptive-icon.png, assets/favicon.png from assets/SVG.svg");
}
