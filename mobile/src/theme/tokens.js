...
export const lightColors = {
  ...
  border: "rgba(26, 92, 72, 0.14)",
  borderStrong: "rgba(26, 92, 72, 0.28)",
  textPrimary: "#1A2B22",
  textSecondary: "#4A5C53",
  textMuted: "#6B7A72",
  primary: "#1A5C48",
  primaryBright: "#2A7A60",
  primaryDark: "#154C3C",
  primarySoft: "rgba(26, 92, 72, 0.12)",
  primaryBorder: "rgba(26, 92, 72, 0.28)",
  secondary: "#1A5C48",
  secondaryBright: "#2A7A60",
  secondaryDark: "#154C3C",
  secondarySoft: "rgba(26, 92, 72, 0.12)",
  secondaryBorder: "rgba(26, 92, 72, 0.28)",
  accentGold: "#E4C56A",
  accentGoldSoft: "rgba(228, 197, 106, 0.22)",
  navy: "#1A2B22",
  onPrimary: "#FFFFFF",
  onPrimaryMuted: "#F5F6F5",
  heroBackground: "#1A5C48",
  heroForeground: "#F3EEE4",
  heroAccent: "#E4C56A",
  success: "#1A5C48",
  danger: "#A8442F",
  accentGreen: "#1A5C48",
  brandYellow: "#E4C56A",
  brandYellowSoft: "rgba(228, 197, 106, 0.2)",
  shadow: "#1A2B22",
  searchBarFill: "#FFFFFF",
  searchBarBorder: "rgba(26, 92, 72, 0.14)",
  onSecondary: "#FFFFFF",
  surfaceElevated: "#FFFFFF",
  surfaceOverlay: "rgba(255,255,255,0.88)",
  focusRing: "rgba(26, 92, 72, 0.36)",
  heroGlow: "rgba(26, 92, 72, 0.1)",
  heroGlowSecondary: "rgba(228, 197, 106, 0.12)",
  dividerSoft: "rgba(26, 92, 72, 0.12)",
};
