...
.${ROOT} .kankreg-process-title{
  font-family:Hanken Grotesk,Inter,system-ui,sans-serif;font-weight:700;font-size:clamp(2rem,5.8vw,4.2rem);
...
.${ROOT} .kankreg-process-opening{
  margin:18px auto 0;max-width:520px;font-family:Hanken Grotesk,Inter,system-ui,sans-serif;font-style:normal;font-weight:600;
...
.${ROOT} .kankreg-process-node{
  ...
  font-family:Hanken Grotesk,Inter,system-ui,sans-serif;font-size:13px;color:rgba(10,9,7,.45);transition:all .35s var(--ease);cursor:default;
}
...
.${ROOT} .kankreg-process-panel-num{color:var(--ghee);font-family:Hanken Grotesk,Inter,system-ui,sans-serif;font-size:1.4rem;letter-spacing:0;text-transform:none}
...
.${ROOT} .kankreg-process-copy h3{
  margin:0 0 10px;font-family:Hanken Grotesk,Inter,system-ui,sans-serif;font-weight:700;
